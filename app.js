...
var finalData = []
  ...
  `
  var chainsToCheck = ['cosmoshub', 'terpnettestnet', 'bitcanna', 'osmosis', 'desmos', 'chihuahua', 'juno', 'stargaze', 'akash', 'axelar', 'kichain', 'kujira', 'meme', 'passage', 'persistence', 'secretnetwork', 'starname', 'likecoin', 'gravitybridge', 'emoney', 'dig', 'bitsong', 'cheqd']
